...
<div className="flex flex-col lg:flex-row bg-white max-w-screen-2xl mx-auto">
    <div className="md:flex h-80 lg:w-1/6 w-full bg-gray-300 border-r hidden">
        <div className="mx-auto py-10">
            <ul>
                <li class="flex space-x-2 cursor-pointer text-black hover:text-[#EC5252] duration-150">
                    <svg
                ...
                <li class="flex space-x-2 cursor-pointer text-black hover:text-[#EC5252] duration-150 mt-2">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="h-6 w-6"
                        fill="none"
